...
#define ARM_MACHINEBB_LOC_PASS_NAME "Dummy ARM machineBB loc pass"

namespace {

class ARMMachineBBloc : public MachineFunctionPass {
public:
    static char ID;

    ARMMachineBBloc() : MachineFunctionPass(ID) { }

    bool runOnMachineFunction(MachineFunction &MF) override;

    StringRef getPassName() const override { return ARM_MACHINEBB_LOC_PASS_NAME; }
...
//             if (opcodename == "Bcc") return false;
//             return true;
//         }       
//     }
//     return false;
...
bool ARMMachineBBloc::runOnMachineFunction(MachineFunction &MF) {
...
INITIALIZE_PASS(ARMMachineBBloc, "ARM-machineBB-loc",
    ARM_MACHINEBB_LOC_PASS_NAME,
    true, // is CFG only?
    true  // is analysis?
)
...
FunctionPass *createARMMachineBBlocPass() { return new ARMMachineBBloc(); }
